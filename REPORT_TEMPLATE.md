...
> 同时 out/report.last.json 会保留**最近一次**运行的副本。
...
| 最近一次 JSON | `out/report.last.json` | `cli.js` 自动同步（最近一次） |
| skill 设计文档 | `REVIEW.md` | 模板，手维护 |
| skill README | `README.md` | 模板，手维护 |
| skill SKILL | `SKILL.md` | 模板，手维护 |
...
| 文件 | 类型 | 更新时机 |
|------|------|---------|
| `REVIEW.md` | **设计文档模板**（手维护） | 改 skill 设计时 |
| `README.md` | **使用说明模板**（手维护） | 改 CLI / 目录结构时 |
| `SKILL.md` | **能力说明模板**（手维护） | 改能力范围时 |
| `REPORT_TEMPLATE.md` | **报告字段说明**（手维护） | 改报告结构时 |
| `out/report.last.json` | **最近一次运行结果**（自动生成） | 每次 cli.js --report |
